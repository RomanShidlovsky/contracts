...
type LoginRequest struct {
	state            protoimpl.MessageState `protogen:"open.v1"`
	LoginOrOwnNumber string                 `protobuf:"bytes,1,opt,name=login_or_own_number,json=loginOrOwnNumber,proto3" json:"login_or_own_number,omitempty"`
...
func (x *LoginRequest) GetLoginOrOwnNumber() string {
	if x != nil {
		return x.LoginOrOwnNumber
	}
	return ""
}
...
const file_auth_service_proto_rawDesc = "" +
	...
	"\rLoginResponse\x12.\n" +
	"\n" +
	"token_pair\x18\x01 \x01(\v2\x0f.auth.TokenPairR\ttokenPair\"5\n" +
	"\x0eRefreshRequest\x12#\n" +
	"\rrefresh_token\x18\x01 \x01(\tR\frefreshToken\"A\n" +
	"\x0fRefreshResponse\x12.\n" +
	"\n" +
	"token_pair\x18\x01 \x01(\v2\x0f.auth.TokenPairR\ttokenPair\"4\n" +
	"\rLogoutRequest\x12#\n" +
